...
class Ui_HareetTashfer(object):
    def setupUi(self, HareetTashfer):
        ...
        self.OpenCode = QtWidgets.QAction(HareetTashfer)
        self.OpenCode.setObjectName("OpenCode")
        self.SaveCode = QtWidgets.QAction(HareetTashfer)
    ...
    def retranslateUi(self, HareetTashfer):
        ...
        self.OpenCode.setText(_translate("HareetTashfer", "فتح شفرة"))
        self.SaveCode.setText(_translate("HareetTashfer", "تسجيل شفرة"))

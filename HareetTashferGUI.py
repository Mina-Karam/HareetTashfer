...
# Form implementation generated from reading ui file 'HareetTashferGUI.ui'
#
...
class Ui_HareetTashfer(object):
    def setupUi(self, HareetTashfer):
        ...
        self.copyButton.setGeometry(QtCore.QRect(60, 460, 131, 31))
        font = QtGui.QFont()
        ...
        self.convertButton.setGeometry(QtCore.QRect(280, 460, 151, 31))
        font = QtGui.QFont()
        font.setPointSize(11)
        ...
        self.facebookButton.setGeometry(QtCore.QRect(360, 530, 81, 21))
        self.facebookButton.setAutoFillBackground(False)
        self.facebookButton.setObjectName("facebookButton")
        self.linkedinButton = QtWidgets.QPushButton(self.centralwidget)
        self.linkedinButton.setGeometry(QtCore.QRect(160, 530, 81, 21))
        self.linkedinButton.setAutoFillBackground(False)
        self.linkedinButton.setObjectName("linkedinButton")
        self.githubButton = QtWidgets.QPushButton(self.centralwidget)
        self.githubButton.setGeometry(QtCore.QRect(260, 530, 81, 21))
        self.githubButton.setAutoFillBackground(False)
        self.githubButton.setObjectName("githubButton")
        self.repoButton = QtWidgets.QPushButton(self.centralwidget)
        self.repoButton.setGeometry(QtCore.QRect(30, 530, 111, 21))
        self.repoButton.setAutoFillBackground(False)
        self.repoButton.setObjectName("repoButton")
        self.L_29 = QtWidgets.QLabel(self.centralwidget)
        self.L_29.setGeometry(QtCore.QRect(270, 210, 51, 20))
        self.L_29.setObjectName("L_29")
        self.T_31 = QtWidgets.QTextEdit(self.centralwidget)
        self.T_31.setGeometry(QtCore.QRect(280, 230, 41, 31))
        self.T_31.setObjectName("T_31")
        self.L_30 = QtWidgets.QLabel(self.centralwidget)
        self.L_30.setGeometry(QtCore.QRect(150, 210, 51, 20))
        self.L_30.setObjectName("L_30")
        self.T_32 = QtWidgets.QTextEdit(self.centralwidget)
        self.T_32.setGeometry(QtCore.QRect(160, 230, 41, 31))
        self.T_32.setObjectName("T_32")
        self.L_31 = QtWidgets.QLabel(self.centralwidget)
        self.L_31.setGeometry(QtCore.QRect(90, 210, 51, 20))
        self.L_31.setObjectName("L_31")
        self.T_33 = QtWidgets.QTextEdit(self.centralwidget)
        self.T_33.setGeometry(QtCore.QRect(100, 230, 41, 31))
        self.T_33.setObjectName("T_33")
        self.L_32 = QtWidgets.QLabel(self.centralwidget)
        self.L_32.setGeometry(QtCore.QRect(330, 210, 51, 20))
        self.L_32.setObjectName("L_32")
        self.T_34 = QtWidgets.QTextEdit(self.centralwidget)
        self.T_34.setGeometry(QtCore.QRect(340, 230, 41, 31))
        self.T_34.setObjectName("T_34")
        HareetTashfer.setCentralWidget(self.centralwidget)
        self.menuBar = QtWidgets.QMenuBar(HareetTashfer)
        ...
        HareetTashfer.setMenuBar(self.menuBar)
        self.Open_Code = QtWidgets.QAction(HareetTashfer)
        self.Open_Code.setObjectName("Open_Code")
        self.Save_Code = QtWidgets.QAction(HareetTashfer)
        self.Save_Code.setObjectName("Save_Code")
        self.Numbering_Code = QtWidgets.QAction(HareetTashfer)
        self.Numbering_Code.setObjectName("Numbering_Code")
        self.Opposite_Numbering_Code = QtWidgets.QAction(HareetTashfer)
        ...
        self.Arabic_Morse_Code = QtWidgets.QAction(HareetTashfer)
        self.Arabic_Morse_Code.setObjectName("Arabic_Morse_Code")
        self.XBOX_Code = QtWidgets.QAction(HareetTashfer)
        self.XBOX_Code.setObjectName("XBOX_Code")
        self.Semaphore_Squares_Code = QtWidgets.QAction(HareetTashfer)
        self.Semaphore_Squares_Code.setObjectName("Semaphore_Squares_Code")
        self.Semaphore_Power_Code = QtWidgets.QAction(HareetTashfer)
        self.Semaphore_Power_Code.setObjectName("Semaphore_Power_Code")
        self.Braille_Code = QtWidgets.QAction(HareetTashfer)
        self.Braille_Code.setObjectName("Braille_Code")
        self.Arabic_Char_Code = QtWidgets.QAction(HareetTashfer)
        self.Arabic_Char_Code.setObjectName("Arabic_Char_Code")
        self.Number_Addition_Code = QtWidgets.QAction(HareetTashfer)
        self.Number_Addition_Code.setObjectName("Number_Addition_Code")
        self.Clock_Code = QtWidgets.QAction(HareetTashfer)
        self.Clock_Code.setObjectName("Clock_Code")
        self.Arabic_English_Code = QtWidgets.QAction(HareetTashfer)
        self.Arabic_English_Code.setObjectName("Arabic_English_Code")
        self.Coordinate_Code = QtWidgets.QAction(HareetTashfer)
        self.Coordinate_Code.setObjectName("Coordinate_Code")
        self.Binary_Morse_Code = QtWidgets.QAction(HareetTashfer)
        self.Binary_Morse_Code.setObjectName("Binary_Morse_Code")
        self.menu.addAction(self.Open_Code)
        self.menu.addAction(self.Save_Code)
        ...
        self.menu_3.addAction(self.Arabic_Morse_Code)
        self.menu_3.addSeparator()
        self.menu_3.addAction(self.XBOX_Code)
        self.menu_3.addAction(self.Semaphore_Squares_Code)
        self.menu_3.addAction(self.Semaphore_Power_Code)
        self.menu_3.addAction(self.Braille_Code)
        self.menu_3.addAction(self.Arabic_Char_Code)
        self.menu_3.addAction(self.Number_Addition_Code)
        self.menu_3.addAction(self.Clock_Code)
        self.menu_3.addAction(self.Arabic_English_Code)
        self.menu_3.addAction(self.Coordinate_Code)
        self.menu_3.addAction(self.Binary_Morse_Code)
    ...
    def retranslateUi(self, HareetTashfer):
        ...
        self.copyButton.setText(_translate("HareetTashfer", "إنسخ"))
        self.convertButton.setText(_translate("HareetTashfer", "حول"))
        ...
        self.L_0.setText(_translate("HareetTashfer", "تشفير \"ئ\""))
        self.LT_1.setText(_translate("HareetTashfer", "إدخل العربي"))
        self.LT_2.setText(_translate("HareetTashfer", "بعد التحويل"))
        self.footerLabel.setText(_translate("HareetTashfer", "Made with Love ♥ | Mina Karam | Um El-Nour Scout Group"))
        self.facebookButton.setText(_translate("HareetTashfer", "Facebook"))
        self.linkedinButton.setText(_translate("HareetTashfer", "LinkedIn"))
        self.githubButton.setText(_translate("HareetTashfer", "GitHub"))
        self.repoButton.setText(_translate("HareetTashfer", "Project Repository"))
        self.L_29.setText(_translate("HareetTashfer", "تشفير \"ء\""))
        self.L_30.setText(_translate("HareetTashfer", "تشفير \"ة\""))
        self.L_31.setText(_translate("HareetTashfer", "تشفير \" \""))
        self.L_32.setText(_translate("HareetTashfer", "تشفير \"ؤ\""))
        self.menu.setTitle(_translate("HareetTashfer", "ملف"))
        self.menu_3.setTitle(_translate("HareetTashfer", "امثلة شفرات"))
        self.Open_Code.setText(_translate("HareetTashfer", "فتح شفرة"))
        self.Save_Code.setText(_translate("HareetTashfer", "حفظ شفرة"))
        ...
        self.Arabic_Morse_Code.setText(_translate("HareetTashfer", "شفرة مورس عربي"))
        self.XBOX_Code.setText(_translate("HareetTashfer", "شفرة دراع الاكس بوكس"))
        self.Semaphore_Squares_Code.setText(_translate("HareetTashfer", "شفرة سيمافور مربعات"))
        self.Semaphore_Power_Code.setText(_translate("HareetTashfer", "شفرة سيمافور رقم أس رقم"))
        self.Semaphore_Power_Code.setToolTip(_translate("HareetTashfer", "شفرة سيمافور رقم أس رقم"))
        self.Braille_Code.setText(_translate("HareetTashfer", "شفرة برايل"))
        self.Arabic_Char_Code.setText(_translate("HareetTashfer", "شفرة الحروف العربي"))
        self.Number_Addition_Code.setText(_translate("HareetTashfer", "شفرة ارقام وجمعها"))
        self.Clock_Code.setText(_translate("HareetTashfer", "شفرة الساعة"))
        self.Arabic_English_Code.setText(_translate("HareetTashfer", "شفرة الانجلش عربي"))
        self.Coordinate_Code.setText(_translate("HareetTashfer", "شفرة الاحداثيات"))
        self.Binary_Morse_Code.setText(_translate("HareetTashfer", "شفرة مورس اعداد ثنائية"))
